...
CONFIGURATION = {
    ...
    # a percentage rate
    "consecutive": {"room": int, "instructors": int, "units": int, "groups": int},
    "system": {"limit": int, "saturation": bool, "tries": int},
}
...
SESSION = {
    ...
    "day": str,
    "time": str,
    "schedule": {"identifier": int, "unit": int, "instructor": int, "group": int},
}
